...
-- 2) country tablosunda bulunan country sütunundaki ülke isimlerinden en az 6 karaktarden
-- oluşan ve sonu 'n' karakteri ile sonlananları sıralayanız.
SELECT country
FROM country
